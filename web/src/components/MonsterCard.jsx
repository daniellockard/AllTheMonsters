...
const MonsterCard = memo(({ monster, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`group relative h-80 bg-gradient-to-br ${gradient} backdrop-blur-sm rounded-2xl border ${borderColor} p-5 cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-black/20 overflow-hidden`}
    >
